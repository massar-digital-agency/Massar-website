...
function CookieSEO() {
  ...
  return (
    <Helmet prioritizeSeoTags>
      ...
      <meta property="og:url" content={`${SITE_URL}/#/cookies`} />
      ...
      <link rel="alternate" hrefLang="ar" href={`${SITE_URL}/#/cookies`} />
      <link rel="alternate" hrefLang="fr" href={`${SITE_URL}/#/cookies`} />
      <link rel="alternate" hrefLang="en" href={`${SITE_URL}/#/cookies`} />
      <link rel="alternate" hrefLang="x-default" href={`${SITE_URL}/#/cookies`} />
    </Helmet>
  )
}
