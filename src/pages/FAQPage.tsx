...
export function FAQPage() {
  ...
  useEffect(() => {
    trackPageView('/faq', `FAQ | ${SEO_CONFIG.siteName}`)
  }, [])

  const seo = t('faq.seo', { returnObjects: true }) as Record<string, string>
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href={`${SEO_CONFIG.siteUrl}/faq`} />
        <meta property="og:type" content="website" />
        <meta property="og:title" content={seo.ogTitle} />
        <meta property="og:description" content={seo.ogDescription} />
        <meta property="og:url" content={`${SEO_CONFIG.siteUrl}/faq`} />
      ...
      <main id="main-content">
        ...
        <FAQ hideHeader ctaHref="/contact" />
      </main>
    </>
  )
}
